...
for layer in map.visible_layers:
    if layer.name == 'Block':
        creer_tuile(layer.tiles(), size_tileset, sprite_group, block_group, 'block')
...
while True:
    ...
    if level == 1:
        ...
        genere_liste_elements, click_again = traiter_envoie(genere_liste_elements, elements_deplacables, click_again, ex_tab_mouv, Joueur)
